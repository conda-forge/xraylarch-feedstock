...
pixi add xraylarch xraylarch-base
# for installing globally
pixi global install xraylarch xraylarch-base
```
...
It is possible to list all of the versions of `xraylarch` available on your platform:
...
```
pixi search xraylarch --channel conda-forge
```
